...
int main()
{
	//network<float>* f = ann::create_network(10, 4, 3, 4, 1,1.00f);
	network_manager<float> n;
	auto c = n.get_instance(10, 4, 3, 4, 1);
	vector<float> inp;
...
//	}
//	unit<float> funit(6);
//	unit<float> f(unitSize);
//	typedef std::chrono::high_resolution_clock Clock;
//	auto t1 = Clock::now();
//	PerceptronLayer<float> a(funit, unitSize);
//	
//	PerceptronLayer<float> b(f, 10);
//	
//	PerceptronLayer<float> c(f, 10);
//	unit<float> fu(10);
//	PerceptronLayer<float> d(fu, 1);
//	/*
